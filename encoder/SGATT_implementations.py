...
from encoder.SGATT import SGATT
from encoder.modules import FeedForwardNetwork, GraphGather


class Graph_encoder(SGATT):

    def __init__(self, node_features_1, edge_features_1,message_size, message_passes,out_features,
        ...
        super(Graph_encoder, self).__init__(node_features_1, edge_features_1,
