...
class SAGTT(nn.Module):
    ...
    def forward(self, adj_1, nd_1, ed_1,de_1,mask_1,bg,entity_emb, relation_emb):
        ...
        kg_batch = KMPNNGNN(bg,entity_emb, relation_emb)
        kg_out = Set2Set(bg,kg_batch)
        # print('kg:',kg_out)
        #Sequence encoder
        ...
        final_emb = output_1 + d1_trans_fts_layer1
