...
def load_data_from_df(SMILES, data_y,add_dummy_node=True, one_hot_formal_charge=False, use_data_saving=True):
    ...
    x_all, y_all = load_data_from_smiles(SMILES, data_y, add_dummy_node=add_dummy_node,
...
def load_data_from_smiles(x_smiles, labels, add_dummy_node=True, one_hot_formal_charge=False):
    ...
    try:
        ...
        dist = featurize_mol(mol, add_dummy_node, one_hot_formal_charge)
