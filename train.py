...
import encoder.SAGTT_implementations
...
MODEL_CONSTRUCTOR_DICTS = {
         'SAGTT': {
        # 'constructor': encoder.SAGTT.SAGTT,
        'constructor': encoder.SAGTT_implementations.Graph_encoder,
        'hyperparameters': {
...
common_args_parser.add_argument('--train-set', type=str, default='/home/ntu/PycharmProjects/T-KG/SAGTT/dataset/Data/BACE/KGsmiles-BACE-val(151)-1.csv', help='Training dataset path')
common_args_parser.add_argument('--valid-set', type=str, default='/home/ntu/PycharmProjects/T-KG/SAGTT/dataset/Data/BACE/KGsmiles-BACE-val(151)-1.csv', help='Validation dataset path')
common_args_parser.add_argument('--test-set', type=str, default='/home/ntu/PycharmProjects/T-KG/SAGTT/dataset/Data/BACE/KGsmiles-BACE-test(151)-1.csv', help='Testing dataset path')
...
common_args_parser.add_argument('--epochs', type=int, default=1, help='Number of training epochs')
