...
import encoder.SGATT_implementations
...
MODEL_CONSTRUCTOR_DICTS = {
         'SGATT': {
        # 'constructor': encoder.SGATT.SGATT,
        'constructor': encoder.SGATT_implementations.Graph_encoder,
        'hyperparameters': {
...
common_args_parser.add_argument('--train-set', type=str, default='/home/ntu/PycharmProjects/Hao/SAGTT/dataset/Data/BACE/KGsmiles-BACE-train(1210)-1.csv', help='Training dataset path')
common_args_parser.add_argument('--valid-set', type=str, default='/home/ntu/PycharmProjects/Hao/SAGTT/dataset/Data/BACE/KGsmiles-BACE-val(151)-1.csv', help='Validation dataset path')
common_args_parser.add_argument('--test-set', type=str, default='/home/ntu/PycharmProjects/Hao/SAGTT/dataset/Data/BACE/KGsmiles-BACE-test(151)-1.csv', help='Testing dataset path')
...
common_args_parser.add_argument('--epochs', type=int, default=10, help='Number of training epochs')
...
def main():
    ...
    test_dataloader = DataLoader(test_dataset, batch_size=args.batch_size,drop_last=True, collate_fn=molgraph_collate_fn)

    ((sample_adj_1, sample_nd_1, sample_ed_1), sample_target, d1, mask1,bg,entity_emb, relation_emb) = train_dataset[0]
    ...
    for epoch in range(args.epochs):
        ...
        for i_batch, batch in enumerate(train_dataloader):
            adj_1, nd_1, ed_1, target, d1, mask_1,bg,entity_emb, relation_emb = batch
            optimizer.zero_grad()
            output = net(adj_1, nd_1, ed_1, d1, mask_1,bg,entity_emb, relation_emb)
